  ...
  <style>
    ...
    * {
    ...
    header {
      ...
      justify-self: center;
      border-radius: 50px;
      background: linear-gradient(45deg, rgb(51, 51, 246), rgb(143, 14, 113));
      z-index: 5;
    ...
    .about h3 {
      ...
      margin-bottom: 10px;
      text-align: center;
      text-shadow: 0 0 8px rgba(0, 13, 255, 0.77);
    }
    ...
    .skill-card:hover {
      transform: scale(1.05);
      transition-duration: 500ms;
      box-shadow: 0 0 15px rgb(0, 72, 255);
    }
    ...
    .timeline-bar:hover {
      box-shadow: 0 0 15px rgba(0, 13, 255, 0.85);
      transition-duration: 500ms;
    }
    ...
    /* Width classes for bars */
    .w20 .timeline-bar::after {
      width: 20%;
    }

    .w30 .timeline-bar::after {
      width: 30%;
    }

    .w40 .timeline-bar::after {
      width: 40%;
    }

    .w50 .timeline-bar::after {
      width: 50%;
    }

    .w60 .timeline-bar::after {
      width: 60%;
    }

    .w70 .timeline-bar::after {
      width: 70%;
    }

    .w80 .timeline-bar::after {
      width: 80%;
    }

    .w90 .timeline-bar::after {
      width: 90%;
    }

    .w100 .timeline-bar::after {
      width: 100%;
    }
    ...
    .bubble {
      ...
      z-index: 5;
      pointer-events: none;
      animation: bubbleFall 10s ease-in-out infinite;
    }
  </style>
</head>
  ...
  <div class="container">
    ...
    <header>
      <div class="avatar-container">
        ...
        <h2 style="color:white; margin-left: 20px; transform:none;">Graphic Designer and Web Developer</h2>
      </div>
      <nav>
        <ul>
    ...
    <section class="about" id="about">
      <div class="one-time-animation">
        ...
        <div class="neon-box">
          <p>
            I am a passionate graphic designer with a strong focus on modern aesthetics and innovative design solutions. My work spans across various design disciplines including branding, advertising, and digital design.<br><br>Learning comprehensively on the job, I continue to develop a broad skill set in areas such as Web Development with HTML 5, CSS 3, Tailwind CSS, Dynamic Web Development with JavaScript, Backend Development with PHP, Tools & Hosting in Web Development with XAMPP, Database Management with MySQL as well as AI Integration, Project Development, and a ChatGPT-Powered FAQ System with APIs.<br><br>As a young technophile, I've always been driven by a passion for innovation and a desire to harness the power of technology. With a strong belief in effort-driven progress, I've developed a growth mindset that has enabled me to improve in various fields—even public speaking. Now, I'm eager to dive even deeper into modern technology and explore its vast possibilities. I aim to become a complete Computer Engineer from mobile computing to web development, UI/UX design, Robotics and IoT and Programming, AI Development, Machine Learning among others. </p>
        </div>
      </div>
    </section>
    ...
    <!-- Bubble Section -->
    <section>
      <div class="bubble" style="width: 10px; height: 10px; left: 3%; background: rgba(0, 162, 249,1);  box-shadow: 0px 0px 10px rgba(0, 110, 253, 0.75); animation-delay: 0s;"></div>
      <div class="bubble" style="width: 13px; height: 13px; left: 13%; background: rgba(126, 186, 255, 0.6); box-shadow: 0px 0px 10px rgba(0, 156, 253, 0.75); animation-delay: 2s;"></div>
      <div class="bubble" style="width: 10px; height: 10px; right: 5%; background: rgba(250, 15, 226, 0.72); box-shadow: 0px 0px 10px rgba(253, 0, 240, 0.61); animation-delay: 4s;"></div>
      <div class="bubble" style="width: 13px; height: 13px; right: 10%; background: rgba(222, 4, 204, 0.6); box-shadow: 0px 0px 10px rgba(253, 0, 240, 0.85); animation-delay: 6s;"></div>

      <div class="bubble" style="width: 10px; height: 10px; left: 7%; background: rgba(0, 162, 249,1);  box-shadow: 0px 0px 10px rgba(0, 110, 253, 0.75); animation-delay: 7s;"></div>
      <div class="bubble" style="width: 13px; height: 13px; left: 10%; background: rgba(126, 186, 255, 0.6); box-shadow: 0px 0px 10px rgba(0, 156, 253, 0.75); animation-delay: 5s;"></div>
      <div class="bubble" style="width: 10px; height: 10px; right: 2%; background: rgba(250, 15, 226, 0.72); box-shadow: 0px 0px 10px rgba(253, 0, 240, 0.61); animation-delay: 7s;"></div>
      <div class="bubble" style="width: 13px; height: 13px; right: 12%; background: rgba(222, 4, 204, 0.6); box-shadow: 0px 0px 10px rgba(253, 0, 240, 0.85); animation-delay: 3s;"></div>
    </section>

    <!-- Skills & Tech Radar -->
    <section class="about" id="skills">
      <div class="one-time-animation">
        <h2>Skills & Tech Radar</h2>
        <p style="color:rgba(219, 219, 219, 0.70); text-align: center;"> One a Scale of 1 - 5</p>

        <h3>Programming and Development</h3>

        <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap:20px; max-width:95%; margin-bottom:1.5rem; margin-top:1.5rem;">
          ...
          <div class="skill-card">
            <h4>Python with Raspberry Pi</h4>
            <p style="font-size:1.4rem;">🟢🟢</p>
          </div>
          <div class="skill-card">
            <h4>C++</h4>
        ...
        <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap:20px; max-width:95%; margin-bottom:1.5rem; margin-top:1.5rem;">
          ...
          <div class="skill-card">
            <h4>Social Media Branding & Campaign Design</h4>
            <p style="font-size:1.4rem;">🟢🟢🟢</p>
          </div>
          <div class="skill-card">
            <h4>Digital Art</h4>
        ...
        <h3 style="text-align:center; margin-top:1rem;">Skill Progression Timeline</h3>
        <div class="timeline-container">
          <span class="timeline-label">Graphic Design - Late 2023</span>
          <div class="timeline-event w30">
            <div class="timeline-bar"></div>
          </div>

          <span class="timeline-label">Graphic Design + Programming - 2024</span>
          <div class="timeline-event w40">
            <div class="timeline-bar"></div>
          </div>

          <span class="timeline-label">Graphic Design + Programming + Web Development - 2025</span>
          <div class="timeline-event w60">
            <div class="timeline-bar"></div>
          </div>
        </div>
      </div>
    ...
    <section class="portfolio" id="portfolio">
      ...
      <div class="projects">
      <div class="project">
          <img src="Esperanza's Fragrances.jpg" alt="Logo For Fragrance Company">
        ...
        <div class="project">
          <img src="Esperanza's Fragrances mockups.jpg" alt="Mockups for Esperanza's Fragrances">
          <div class="project-content">
            <h3>Brand Identity</h3>
            <p>A modern brand identity for a Fragrance Company.</p>
          </div>
        ...
        <div class="project">
          <img src="Esperanza's Fragrances Thank You.jpg" alt="Thank you Flyer For Fragrance Company">
          <div class="project-content">
            <h3>Brand Identity</h3>
            <p>A modern brand identity for a Fragrance Company.</p>
          </div>
        ...
        <div class="project">
          <video width="500px" height="380px" autoplay muted loop alt="Walking T-Shirt Mockup">
            <source src="ESA Shirt video.mp4" type="video/mp4">
          </video>
          <div class="project-content">
            <h3>T-Shirt Mockup</h3>
            <p>A modern walking T-Shirt Mockup for a School Student Association.</p>
          </div>
        </div>

        <div class="project">
          <video autoplay muted loop alt="Online basic Calculator">
            <source src="Sign Up 1.mp4" type="video/mp4">
          </video>
          <div class="project-content">
            <h3>Basic Sign Up/In Page</h3>
            <p>Basic Sign Up/In Page for a Digital Banking System.</p>
          </div>
        </div>

        
        <div class="project">
          <video width="500px" height="380px" autoplay muted loop alt="Online basic Calculator">
            <source src="Calculator App.mp4" type="video/mp4">
          </video>
          <div class="project-content">
            <h3>Online basic Calculator</h3>
            <p>An Online Basic Calculator.</p>
          </div>
        </div>
    ...
    <section>
      <div class="bubble" style="width: 10px; height: 10px; left: 3%; background: rgba(0, 162, 249,1);  box-shadow: 0px 0px 10px rgba(0, 110, 253, 0.75); animation-delay: 0s;"></div>
      <div class="bubble" style="width: 13px; height: 13px; left: 13%; background: rgba(2, 82, 174, 0.6); box-shadow: 0px 0px 10px rgba(0, 156, 253, 0.75); animation-delay: 2s;"></div>
      <div class="bubble" style="width: 10px; height: 10px; right: 5%; background: rgba(250, 15, 226, 0.72); box-shadow: 0px 0px 10px rgba(253, 0, 240, 0.61); animation-delay: 4s;"></div>
      <div class="bubble" style="width: 13px; height: 13px; right: 10%; background: rgba(222, 4, 204, 0.701); box-shadow: 0px 0px 10px rgba(253, 0, 240, 0.85); animation-delay: 6s;"></div>

      <div class="bubble" style="width: 10px; height: 10px; left: 7%; background: rgba(0, 162, 249,1);  box-shadow: 0px 0px 10px rgba(0, 110, 253, 0.75); animation-delay: 7s;"></div>
      <div class="bubble" style="width: 13px; height: 13px; left: 10%; background: rgba(7, 24, 255, 0.84); box-shadow: 0px 0px 10px rgba(0, 156, 253, 0.75); animation-delay: 5s;"></div>
      <div class="bubble" style="width: 10px; height: 10px; right: 2%; background: rgba(250, 15, 226, 0.797); box-shadow: 0px 0px 10px rgba(253, 0, 240, 0.61); animation-delay: 7s;"></div>
      <div class="bubble" style="width: 13px; height: 13px; right: 12%; background: rgba(255, 0, 234, 0.735); box-shadow: 0px 0px 10px rgba(253, 0, 240, 0.85); animation-delay: 3s;"></div>
    </section>

    <!-- Contact Section -->
    <section class="contact" id="contact">
      <h2>Contact Me</h2>
      <p style="color:rgba(219, 219, 219, 0.70); text-align: center;">It would be lovely to hear from you</p>
